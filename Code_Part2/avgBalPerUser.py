...
file_pathout = 'D:/Ash/UFL/Sem2/Blockchain Optimization and Applications/HW2/compressed/data/txout.csv'


# In[3]:


file_pathin = 'D:/Ash/UFL/Sem2/Blockchain Optimization and Applications/HW2/compressed/data/txin.csv'
...
print(ans['balance'].sum()/4318422)  #Answer for Part 2
